...
public class GuiAchievements extends GuiScreen
{
    ...
    protected void func_27109_b(int i, int j, float f)
    {
        ...
        if(achievement != null)
        {
            ...
            fontRenderer.drawStringWithShadow(s, k5, j6, field_27120_x.func_27181_b(achievement2) ? achievement2.getSpecial() ? -128 : -1 : achievement2.getSpecial() ? 0xff808040 : 0xff808080);
        }
        GL11.glEnable(2929 /*GL_DEPTH_TEST*/);
        GL11.glEnable(2896 /*GL_LIGHTING*/);
