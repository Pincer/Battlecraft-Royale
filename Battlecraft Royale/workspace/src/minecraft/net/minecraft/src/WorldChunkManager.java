...
public class WorldChunkManager
{
    ...
    {
        field_4194_e = new NoiseGeneratorOctaves2(new Random(world.getRandomSeed() * 9871L), 4);
        field_4193_f = new NoiseGeneratorOctaves2(new Random(world.getRandomSeed() * 39811L), 4);
        field_4192_g = new NoiseGeneratorOctaves2(new Random(world.getRandomSeed() * 0x84a59L), 2);
    }
